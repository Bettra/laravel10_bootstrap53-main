...
use App\Http\Controllers\NilaiAhmadController;
...
Route::group(['middleware' => 'auth'], function (){
    ...
    Route::get('nilai', [NilaiAhmadController::class, 'index'])->name('nilai.index');
    Route::get('cetak_nilai', [NilaiAhmadController::class, 'cetak_nilai'])->name('cetak_nilai');
